      ...
      <main className="flex-grow flex items-center justify-center py-12">
        <div className="container mx-auto px-4 max-w-2xl">
          <Card className="shadow-lg">
            ...
            <CardContent>
              <Tabs defaultValue="pessoa" onValueChange={setTipoUsuario} className="w-full">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="nome" placeholder="Seu nome completo" required className="input-focus" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="cpf">CPF</Label>
                        <Input id="cpf" placeholder="000.000.000-00" required className="input-focus" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="telefone" placeholder="(00) 00000-0000" required className="input-focus" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="senha" type="password" required className="input-focus" />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="confirmarsenha">Confirmar Senha</Label>
                        <Input id="confirmarsenha" type="password" required className="input-focus" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="endereco" placeholder="Seu endereço completo" required className="input-focus" />
                    </div>
